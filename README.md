...
[![Version](https://img.shields.io/badge/version-1.0.0-blue?style=flat-square)](https://github.com/victoralv/exchange-converter/releases)
...
[![GitHub Stars](https://img.shields.io/github/stars/victoralv/exchange-converter?style=flat-square&logo=github)](https://github.com/victoralv/exchange-converter)
...
[📋 SKILL.md](SKILL.md) · [🐛 Report an Issue](https://github.com/victoralv/exchange-converter/issues)
...
3. Paste this URL:
```
https://github.com/victoralv/exchange-converter
```
4. Confirm. The skill will load and activate **Exchange Converter v1.0.0**.

### Option 2: Clone locally
```bash
git clone https://github.com/victoralv/exchange-converter.git
```
...
Contributions are welcome! Open a Pull Request or file an Issue on [GitHub](https://github.com/victoralv/exchange-converter).
